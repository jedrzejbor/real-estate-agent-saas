...
export const AnalyticsEventName = {
  ...
  FAVORITE_LISTING_ADDED: 'favorite_listing_added',
  FAVORITE_LISTING_REMOVED: 'favorite_listing_removed',
  FAVORITE_LOGIN_PROMPT_SHOWN: 'favorite_login_prompt_shown',
  FAVORITES_PROFILE_OPENED: 'favorites_profile_opened',
