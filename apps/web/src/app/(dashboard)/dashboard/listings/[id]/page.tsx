...
} from '@/components/dashboard/detail-tabs';
import {
  ...
  return (
    <div className="space-y-6">
      ...
      <DashboardDetailTabs
        ...
        ariaLabel="Widok szczegółów oferty"
        fallbackBadge={LISTING_STATUS_LABELS[listing.status]}
...
type ListingDetailTab = DashboardDetailTab<ListingDetailTabId>;
